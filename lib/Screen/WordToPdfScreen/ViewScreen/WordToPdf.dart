...
class _WordToPdfConverterState extends State<WordToPdfConverter> {
  ...
  var provider=WordToPdfProvider();
  ...
  Widget build(BuildContext context) {
    return Consumer<WordToPdfProvider>(builder: (context, value, child) {
      return Scaffold(
        appBar: AppBar(
          leading: IconButton(
                ...
                children: <Widget>[
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                        manager.wordFile != null
                            ? manager.wordFile!.path.split('/').last
                      ...
                      trailing: ElevatedButton.icon(
                        ...
                        onPressed: provider.pickWordFile,
                  ...
                  manager.isLoading
                      ...
                      : ElevatedButton.icon(
                          ...
                          onPressed: provider.convertWordToPdf,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.blue,
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: provider.sharePdfFile,
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.blue,
                  ...
                  if (manager.pdfFile != null)
                    Padding(
                      ...
                      child: Text(
                        'PDF File Ready: ${manager.pdfFile!.path.split('/').last}',
